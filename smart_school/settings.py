...
SECRET_KEY = 'tr7whlaz_jp7%j+bgyl6-%#z8of7021*ra!+(36e75jn3@nsr8'
...
SIMPLE_JWT = {
    ...
    'VERIFYING_KEY': None,
    'AUTH_HEADER_TYPES': ('JWT',), # This is used in React's Headers
    'USER_ID_FIELD': 'id',
...
JWT_AUTH = {
    'JWT_RESPONSE_PAYLOAD_HANDLER': 'smart_school.utils.my_jwt_response_handler'
}
